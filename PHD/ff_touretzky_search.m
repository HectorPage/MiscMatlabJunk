...
for adx = 1:numel(RC)
    ...
    parentpath = ['~/video_conflict/ff_plasticity/parameter_search'];
    ...
    for idx = 1:numel(phiE)
        ...
        for jdx = 1:numel(phiI)
            ...
            mkdir(tier_3_path);
            copyfile('~/video_conflict/ff_plasticity/parameter_search/plastic_touretzky', tier_3_path);
            cd(tier_3_path);
            ...
            plot_ff_touretzky(5.0, 0.0001, 500, 'save', 'Y');
